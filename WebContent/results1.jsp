...
<tr>
    ...
    exam=ud.getExamInfo(course);
   //out.println(student.size());
			tableStr+="<table id="+"dynamic_table"+" border='1'><tr><th>S No.</th><th>Email Id</th><th>Course</th><th>Marks</th><th>Max Marks</th><th>Percentage</th></tr>";
			int i=1;
