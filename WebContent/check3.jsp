...
<body>
	...
	<div class="cp1">
	 	...
	 	if(user==null)
	 	{
			...
			{
				if(ud.isUserExistsInExams(email)){
				response.sendRedirect("results.jsp");
				}
				else{
					out.print("Take exam first and then see the results");
				}
			}
			else if(ud.isUserExistsInStudents(email))
			{
				out.print("Your Admission not yet Approved by Admin-wait for approval after that you can take exam");
			}
