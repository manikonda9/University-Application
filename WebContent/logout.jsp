<%@ page language="java" contentType="text/html; charset=ISO-8859-1" import="java.util.*" import="university.*"
...
<td><input type="password" name="password" id="password" placeholder="Enter Password"/><span id="passwordSpan"></span></td>
	...
	<%
      ...
      %>
            <!--  <div class="logout">You Logged Out Successfully:<br/><br/><br/>
             <a href="homepage.jsp"><input type="submit" name="home" value="Go To Home" /></a>
             <a href="Login.jsp"><input type="submit" name="home" value="LogIn" /></a>
             </div>
