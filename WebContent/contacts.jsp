...
User user=(User)session.getAttribute("user");
    ...
    contacts=ud.getContacts();
    //out.println(student.size());
			tableStr+="<table id="+"dynamic_table"+" border='1'><tr><th>S.No</th><th>Name</th><th>Email id</th><th>Mobile Number</th><th>Comments</th></tr>";
			int i=1;
				for(User eachUser:contacts){
					tableStr+="<tr><td>"+i+"</td>";
					tableStr+="<td>"+eachUser.getFirstname()+"</td>";
					tableStr+="<td>"+eachUser.getEmailid()+"</td>";
					tableStr+="<td>"+eachUser.getMobilenumb()+"</td>";
					tableStr+="<td>"+eachUser.getTopic()+"</td></tr>";
 					i++;
				}
